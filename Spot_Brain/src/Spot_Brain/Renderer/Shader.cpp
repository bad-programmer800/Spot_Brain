...
namespace Brain {
	...
	Brain::Ref<Brain::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Brain::Ref<Brain::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	Brain::Ref<Brain::Shader> ShaderLibrary::Get(const std::string& name)
	{
